...
# Only load local env file if it exists
if os.path.exists('env_local.txt'):
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-trading-journal-2024-production-key-change-me')
...
# Database configuration - Temporary SQLite for debugging
DATABASES = {
    'default': {
...
# Uncomment below for Supabase PostgreSQL (when network issues are resolved)
# DATABASES = {
#     'default': {
